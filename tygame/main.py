    ...
    def write(self,button,mods):
        ...
        for line in final_lines: 
          ...
          if line != "":
              ...
              if justification == 0:
                  self._buffer.blit(tempsurface, (0, accumulated_height))
              elif justification == 1:
                  self._buffer.blit(tempsurface, (self._x / 2, accumulated_height))
              elif justification == 2:
                  self._buffer.blit(tempsurface, (self._x, accumulated_height))
              else:
